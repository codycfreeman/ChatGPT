export function parsePlainText(md){
  ...
  const isJunk=l=>!l||
    /^(Title:?|URL|URL Source|Source|Published|Markdown|Daily Reflections\b|Daily Reflection\b|\[Skip|\[Search|Search\s+\[x\]|=+$|-+$)/i.test(l)||
    /alcoholics anonymous|aa grapevine/i.test(l)||
